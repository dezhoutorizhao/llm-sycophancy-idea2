...
###
 ...
 # @Date               : 2024-10-18 18:56
 # @Last Modified By   : 陈蔚 (weichen.cw@zju.edu.cn)
 # @Last Modified Date : 2024-10-18 18:59
 # @Description        : 
 # -------- 
 # Copyright (c) 2024 Alibaba Inc. 
### 

# EXAMPLE SCRIPT: WORLD_SIZE=1 MASTER_ADDR=localhost MASTER_PORT=12345 RANK=0 NGPUS=8 CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 bash scripts/sft-lora.sh
...
# PEFT arguments
peft_type=lora
peft_config=/path/to/lora_config.json
