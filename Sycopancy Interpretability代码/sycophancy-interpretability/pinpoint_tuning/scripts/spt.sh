...
###
 ...
 # @Last Modified Date : 2024-10-18 19:29
 # @Description        : 
 # -------- 
 # Copyright (c) 2024 Alibaba Inc. 
### 

# EXAMPLE SCRIPT: WORLD_SIZE=1 MASTER_ADDR=localhost MASTER_PORT=12345 RANK=0 NGPUS=8 CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 bash scripts/spt.sh
...
path_patching_path=/path/to/path_patching_results
